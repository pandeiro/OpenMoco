...
- [ ] Task: Document plugin installation methods
    - [ ] npm global install approach
    - [ ] Local file approach (current moko-logger pattern)
    - [ ] opencode.json plugin array approach
